...
![image-20211020163951054](/static/images/techs/image-20211020163951054.png)
...
抽象字符编号可以是字符编码，例如 ASCII 编码，也可以是经过一定规则转换后的编码，例如 utf-8 编码、utf-16 编码。
